...
const FINAL_ROADBOOK = [
  ...
  },
  {
    ...
    legs: [
      { from: "芒康县城酒店", to: "左贡县城中心", via: "G318 → 如美 → 觉巴山 → 东达山" },
      { from: "左贡县城中心", to: "邦达镇", via: "全程 G318；邦达补给并更换司机" },
    ...
    stops: [
      ...
      { name: "八宿县城", location: "西藏自治区昌都市八宿县 · 白玛镇", time: "抵达即入住", intro: "藏东 G318 上成熟的补给和住宿节点，本日主要承担休息，不再追加游览。", note: "不继续赶往然乌" }
    ],
  ...
  },
  {
    ...
    legs: [
      { from: "林芝市巴宜区酒店", to: "巴松措游客中心", via: "林拉高等级公路 → 工布江达方向 → S504 / 景区连接线" },
      { from: "巴松措游客中心", to: "拉萨城关区酒店（实际地址）", via: "S504 返回 → 林拉高等级公路 → 拉萨；不要走乡村近路" }
    ],
    stops: [
      { name: "巴松措", location: "西藏自治区林芝市工布江达县 · 错高乡", time: "2.5–3 小时", intro: "湖泊、森林、雪山与湖心岛组合成熟，是林芝到拉萨途中步行压力较低的重点湖景。", note: "景交与湖心岛轻量游，不深走结巴村" },
      { name: "尼洋河 / 林拉公路服务区", location: "西藏自治区林芝市 · 巴宜区至工布江达县沿线", time: "合计 30 分钟", intro: "尼洋河谷是林拉通道的核心自然背景，服务区停靠以驾驶恢复和快速观景为主。", note: "只用于休息和司机轮换" }
    ],
  ...
  },
  {
    ...
    legs: [
      { from: "拉萨酒店（实际地址）", to: "布达拉宫票面指定入口", via: "网约车或步行；按预约短信核对入口，不只搜景区名称" },
      { from: "布达拉宫出口", to: "大昭寺广场安检口", via: "网约车或步行；以现场人流管制为准" },
      { from: "大昭寺出口", to: "八廓街", via: "步行进入传统转经街区，按现场指引顺时针游览" },
      { from: "八廓街", to: "拉萨酒店（实际地址）", via: "步行或网约车；药王山按体力单独加一段" }
    ],
    stops: [
      { name: "布达拉宫", location: "西藏自治区拉萨市城关区 · 北京中路", time: "2.5–3 小时", intro: "拉萨地标性的宫堡建筑群，兼具政治、宗教和艺术史价值，参观重点是建筑空间与壁画文物。", note: "按预约时段入场，台阶慢走" },
      { name: "大昭寺", location: "西藏自治区拉萨市城关区 · 八廓街古城中心", time: "1–1.5 小时", intro: "拉萨老城最重要的藏传佛教寺院之一，寺前广场与信众转经构成核心人文场景。", note: "预约和安检时间另留余量" },
      { name: "八廓街", location: "西藏自治区拉萨市城关区 · 大昭寺环线", time: "1.5–2 小时", intro: "围绕大昭寺形成的传统转经街区，藏式建筑、商铺和日常宗教活动集中。", note: "人文拍照与甜茶休息结合" },
      { name: "药王山观景台", location: "西藏自治区拉萨市城关区 · 布达拉宫西南侧", time: "20–30 分钟", intro: "布达拉宫经典正面拍摄机位，可以用较短时间完成拉萨城市地标照片。", note: "体力允许再加" }
    ],
