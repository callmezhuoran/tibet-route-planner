...
import {
  ...
  Hotel, MapPin, Maximize2, MoonStar, Route, ShieldAlert, Utensils, X
} from "lucide";
...
const UI_ICONS = {
  ...
  MapPin, Maximize2, MoonStar, Route, ShieldAlert, Utensils, X
};
...
const FINAL_ROADBOOK = [
  {
    ...
    food: ["牦牛肉汤锅", "高原土豆", "酥油茶"],
    evening: { plan: "酒店汤锅 + 院内观星", duration: "60–90 分钟 · 21:00 前回房", note: "先看高反状态；天气晴且无头痛时只在酒店院内观星 15–20 分钟，不夜驾寻找机位。" },
    legs: [
  ...
  },
  {
    ...
    food: ["牦牛肉火锅", "菌菇汤", "青稞饼"],
    evening: { plan: "晚餐 + 照片备份", duration: "60–90 分钟 · 21:30 前结束", note: "住镇中心可在酒店周边慢走 20 分钟；给设备充电并备份照片，不再开车追星或找夜景。" },
    legs: [
  ...
  },
  {
    ...
    evening: { plan: "小团确认 + 格萨尔广场锅庄（可选）", duration: "45–90 分钟 · 21:00 前结束", note: "先完成司机、车牌和天气确认；无头痛气喘再短看锅庄，海拔约 4000 米不跟跳、不久站。" },
    legs: [
  ...
  },
  {
    ...
    evening: { plan: "牦牛肉晚餐 + 照片备份", duration: "60–90 分钟 · 21:30 前休息", note: "格聂往返后不再外出；整理次日主车行李，检查油量和胎压，保证睡眠。" },
    legs: [
  ...
  },
  {
    ...
    evening: { plan: "芒康晚餐 + 主车检查", duration: "60–90 分钟 · 21:00 前结束", note: "确认燃油、电量、胎压和次日 G318 路况；只在酒店周边活动，不饮酒、不泡久热水澡。" },
    legs: [
  ...
  },
  {
    ...
    evening: { plan: "左贡补给 + 酒店周边慢走", duration: "60–90 分钟 · 21:30 前结束", note: "本日较早入住，可采购水和零食、散步 20–30 分钟；晚间仍以恢复为主。" },
    legs: [
  ...
  },
  {
    ...
    evening: { plan: "八宿早休 + 车辆复查", duration: "45–60 分钟 · 21:00 前休息", note: "刹车充分冷却后查看轮胎和仪表异常；长下坡日不再安排夜间活动。" },
    legs: [
  ...
  },
  {
    ...
    food: ["途中简餐", "波密石锅鸡", "菌菇菜"],
    evening: { plan: "石锅鸡 + 波密县城慢走", duration: "90–120 分钟 · 22:00 前结束", note: "利用较低海拔恢复，可在酒店附近主街散步；不进入无照明河岸或乡村支路。" },
    legs: [
  ...
  },
  {
    ...
    evening: { plan: "工布公园夜景 + 尼洋河短走", duration: "60–90 分钟 · 21:30 前回酒店", note: "只选酒店到公园的短程网约车，散步控制在 30–45 分钟；回酒店后加油并收拾次日进拉萨行李。" },
    legs: [
  ...
  },
  {
    ...
    evening: { plan: "布宫夜景 / 宇拓路短走（二选一）", duration: "60–90 分钟 · 21:30 前结束", note: "布达拉宫广场适合地标夜景，宇拓路连接布宫与八廓街；当天下午已走老城时，不再两处全刷。" },
    legs: [
  ...
  },
  {
    ...
    food: ["甜茶", "藏面早餐", "机场简餐"],
    evening: { plan: "成都酒店附近晚餐 + 休息", duration: "60–90 分钟", note: "按 10月7日航班位置选酒店；住机场附近就不再进市中心，避免返程夜继续折腾。" },
    legs: [
    ...
    <article class="roadbook-day" data-tone="${day.tone}">
      ...
      <div class="roadbook-day-body">
        ...
        <dl class="roadbook-operations">
          ...
          <div class="roadbook-evening">
            <dt><i data-lucide="moon-star" aria-hidden="true"></i>晚上安排</dt>
            <dd>
              <strong>${day.evening.plan}</strong>
