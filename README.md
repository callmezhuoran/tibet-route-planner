...
按 **2026-09-26 成都出发、2026-10-06 离开拉萨** 编排：

> 成都 -> 汶川/卧龙 -> 四姑娘山 -> 丹巴 -> 塔公 -> 新都桥 -> 雅江 -> 理塘 -> 格聂之眼一日小团往返 -> 海子山姊妹湖 -> 巴塘 -> 芒康 -> 左贡 -> 八宿 -> 然乌 -> 波密 -> 鲁朗 -> 林芝 -> 拉萨

- 11 天 / 10 晚，约 2400–2600 km，预计纯驾驶 58–65 小时。
- 9/26 住四姑娘山镇，之后依次住新都桥、理塘连住两晚、芒康、左贡、八宿、波密、林芝，10/5 中午前后抵达拉萨并住一晚。
- 9/29 主车留在理塘酒店，参加当地 5–7 座包车往返格聂之眼，不进行格木至巴塘全穿越。携程/去哪儿现有参考产品为 910 元起，9/29 实际价格、车型和保险需要二次确认。
- 9/30 自驾主车重新走 G318，经海子山姊妹湖、巴塘到芒康；10/1 只到左贡，10/2 再到八宿，已取消原 9–11 小时极限驾驶日。
- 取消巴松措和拉萨整日游。10/5 沿林拉高等级公路直达拉萨，下午只做大昭寺、八廓街和布达拉宫外景。
- 完整逐日安排、停留时间、住宿、路况、驾驶注意和餐饮见：[最终路书 ROADBOOK.md](./ROADBOOK.md)。
...
- G317 / G318 / 格聂南线 / 川西环线使用平滑曲线，点击地图上的路线可直接加粗并显示摘要。
- 一键突出川藏大环线或川西小环线。
- 全国视图与川藏区域聚焦切换、滚轮缩放和拖动画面。
- 景点使用带 A / B / C 分级的圆形标记；桌面聚焦视图展示带指向线的文本框，移动端点击圆点后单独展开。
...
以下暂按整车 / 团队总价理解，最终比较前必须统一是否包含保险、异地还车、油电、过路停车、司机食宿、返空费和救援等口径。

| 方案 | 当前报价 | 4 人均摊 | 主要收益 | 主要风险 |
| --- | ---: | ---: | --- | --- |
| 成都租车自驾、拉萨异地还车 | 10000-12000 | 2500-3000 | 两名司机可轮换，路线最自由；坦克 300 至理想 L6 均有车型 | 若只是裸租，保险、油费、异地还车和超里程会吃掉价差；事故和改线由团队处理 |
| 旅行社独立小团、路线可商定 | 13500 | 3375 | 司机熟路，合同和客服体系通常更完整，乘员可以休息 | 需防车型降级、随机派司机、购物和返空等隐藏费用 |
| 朋友推荐的司机 / 服务方 | 约 15000 | 3750 | 有熟人体验背书，司机稳定性和沟通可能更好 | 报价最高；熟人推荐不能代替资质、营运保险和正式合同 |

当前倾向：如果自驾 10000-12000 已含租金、基础保险和异地还车，补齐油费与增补保险后仍明显低于包车，则 **G318 主线自驾的性价比最高**。团队有两名可轮换驾驶员是明显加分项，但格聂南线和南极洛仍应换当地接驳或熟路司机。

### 路况与自驾边界

- G318 成都至拉萨总体以铺装路面为主；林芝至芒康大部分为柏油路，波密至鲁朗已实现沥青路面贯通，林芝至拉萨为高等级公路。
- 铺装路不等于低难度。折多山、觉巴山、东达山、业拉山和怒江 72 拐仍有高海拔弯道、长下坡、暗冰、落石、大车和临时管制风险。
- G227 理塘至稻城亚丁的干线路况已经明显改善，城市 SUV 可走；亚丁的体力负担主要发生在景区游览而非公路驾驶。
- 格聂南线仍有炮弹坑、碎石和非铺装段，且垭口接近 5000 米。只建议高底盘、有合适轮胎和备胎的车辆，由熟路司机执行；理想 L6 不作为穿越车型。
- G214 香格里拉经德钦、盐井至芒康以铺装路为主，但峡谷临崖、落石和汛期塌方风险高，不能夜行。
- 南极洛自驾只解决抵达巴迪乡附近的问题，核心景观还需要当地接驳和高海拔徒步，至少留两天。
- 纳木错与羊卓雍措均可通过铺装道路抵达；纳木错更高、更远，也更容易受风雪结冰影响，难度明显高于羊卓雍措。
- 两名司机按身体状态而不是性别轮换。单人出现头痛、反应变慢、困倦或服用影响驾驶的药物时，必须立刻停止驾驶。

详细的逐路段难度、报价利弊和自驾执行底线已经加入网页的“用车决策”页签。
